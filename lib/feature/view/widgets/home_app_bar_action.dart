      ...
      return Row(
        ...
        children: [
          _buildActionButton(
            ...
            icon: Stack(
              clipBehavior:
                  Clip.none, // Allows the badge to sit outside the icon
              children: [
          ...
          _buildActionButton(
            ...
            icon: Icon(
              ...
              color: isDark
                  ...
                  : scheme.primary, // Pop accent color for mode trigger
            ),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(
            16), // Rounded capsule look to align with the bottom nav
